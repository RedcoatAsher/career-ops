...
Determine the correct tracker based on the role's geo:
- UK / Europe / EMEA job → `data/applications.md`
- US / Americas / Remote-US job → `data/applications-us.md`
- Unknown / fully remote → `data/applications.md` (default)

Register in the correct tracker with all columns including Report and PDF as ✅.
...
**Determine folder:**
- UK/Europe/EMEA job → `UK Applications`
- US/Americas or explicitly Remote-US job → `US Applications`
