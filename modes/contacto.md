...
4. **Generate message** with 3-sentence framework adapted to the contact type:
   ...
   ### Hiring Manager
   - **Sentence 1 (Hook)**: Specific challenge their team faces (extracted from the JD, company blog, or news)
   - **Sentence 2 (Proof)**: Candidate's most quantifiable achievement demonstrating they've solved similar problems
