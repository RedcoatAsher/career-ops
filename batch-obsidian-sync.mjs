...
const evaluations = [
  ...
  { num: '012', slug: '012-parloa-ai-agent-architect',          status: 'SKIP',      geo: 'UK', folder: 'UK Applications' },
  ...
  { num: '015', slug: '015-parloa-fde-devops',                  status: 'SKIP',      geo: 'UK', folder: 'UK Applications' },
  { num: '016', slug: '016-parloa-fde-voip',                    status: 'SKIP',      geo: 'UK', folder: 'UK Applications' },
  { num: '017', slug: '017-parloa-senior-fde',                  status: 'Evaluated', geo: 'UK', folder: 'UK Applications' },
  { num: '018', slug: '018-parloa-partner-se-dach',             status: 'SKIP',      geo: 'UK', folder: 'UK Applications' },
  ...
  { num: '022', slug: '022-polyai-agent-designer',              status: 'SKIP',      geo: 'UK', folder: 'UK Applications' },
  // --- Anthropic ---
  ...
  { num: '028', slug: '028-anthropic-applied-ai-life-sci',      status: 'SKIP',      geo: 'UK', folder: 'UK Applications' },
  ...
  { num: '035', slug: '035-intercom-sa',                        status: 'SKIP',      geo: 'US', folder: 'US Applications' },
  { num: '036', slug: '036-intercom-senior-se',                 status: 'Evaluated', geo: 'UK', folder: 'UK Applications' },
  { num: '037', slug: '037-intercom-se',                        status: 'SKIP',      geo: 'US', folder: 'US Applications' },
  // --- Glean ---
  ...
  { num: '040', slug: '040-glean-sa-emea',                      status: 'SKIP',      geo: 'US', folder: 'US Applications' },
  ...
  { num: '044', slug: '044-arize-ai-solutions-eng-emea',        status: 'SKIP',      geo: 'US', folder: 'US Applications' },
  { num: '045', slug: '045-arize-ai-pm',                        status: 'Evaluated', geo: 'US', folder: 'US Applications' },
  { num: '046', slug: '046-arize-ai-solutions-eng',             status: 'SKIP',      geo: 'US', folder: 'US Applications' },
  // --- Vercel ---
  ...
  { num: '050', slug: '050-vercel-sa',                          status: 'SKIP',      geo: 'US', folder: 'US Applications' },
  { num: '051', slug: '051-vercel-sw-eng-agent',                status: 'SKIP',      geo: 'US', folder: 'US Applications' },
  // --- Airtable ---
  ...
  { num: '054', slug: '054-airtable-senior-partner-sa',         status: 'SKIP',      geo: 'UK', folder: 'UK Applications' },
  ...
  { num: '062', slug: '062-decagon-customer-eng-agent',         status: 'SKIP',      geo: 'US', folder: 'US Applications' },
  { num: '063', slug: '063-deepgram-se-enterprise',             status: 'SKIP',      geo: 'US', folder: 'US Applications' },
  { num: '064', slug: '064-livekit-fde',                        status: 'SKIP',      geo: 'US', folder: 'US Applications' },
  { num: '065', slug: '065-salient-fde-sw',                     status: 'SKIP',      geo: 'US', folder: 'US Applications' },
  ...
  { num: '068', slug: '068-baseten-fde',                        status: 'SKIP',      geo: 'US', folder: 'US Applications' },
  { num: '069', slug: '069-fireworks-ai-fde',                   status: 'SKIP',      geo: 'US', folder: 'US Applications' },
  { num: '070', slug: '070-lorikeet-fde',                       status: 'SKIP',      geo: 'UK', folder: 'UK Applications' },
  { num: '071', slug: '071-tavily-fde-partnerships',            status: 'SKIP',      geo: 'UK', folder: 'UK Applications' },
  { num: '072', slug: '072-adaptive-ml-fde',                    status: 'SKIP',      geo: 'US', folder: 'US Applications' },
  { num: '073', slug: '073-reflection-ai-fde',                  status: 'Evaluated', geo: 'US', folder: 'US Applications' },
  { num: '074', slug: '074-workato-senior-fde',                 status: 'SKIP',      geo: 'US', folder: 'US Applications' },
  ...
  { num: '078', slug: '078-labelbox-fde',                       status: 'SKIP',      geo: 'US', folder: 'US Applications' },
  ...
  { num: '084', slug: '084-anthropic-fde-federal',              status: 'SKIP',      geo: 'US', folder: 'US Applications' },
  { num: '085', slug: '085-polyai-fde-pst',                     status: 'SKIP',      geo: 'US', folder: 'US Applications' },
  { num: '086', slug: '086-parloa-senior-lead-fde-us',          status: 'Evaluated', geo: 'US', folder: 'US Applications' },
  { num: '087', slug: '087-hume-ai-sr-ai-research-eng',         status: 'SKIP',      geo: 'US', folder: 'US Applications' },
